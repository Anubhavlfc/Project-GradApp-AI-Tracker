...
const STATUSES = ['researching', 'in_progress', 'applied', 'interview', 'decision']
const DECISIONS = ['pending', 'accepted', 'rejected', 'waitlisted']

export default function EditApplicationModal({ application, onClose, onSubmit }) {
  const [formData, setFormData] = useState({
    school_name: application.school_name || '',
    program_name: application.program_name || '',
    degree_type: application.degree_type || 'MS',
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Decision (only show for decision status) */}
